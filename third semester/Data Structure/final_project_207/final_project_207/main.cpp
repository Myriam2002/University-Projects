...
//---------------------------------------------------------------------------------------
    ...
    */
    ...
    void BFT(struct Node* root) // noreen // breadth first traversal
    {
       queue<Node*> q;
        if (!root) {
            return;
    ...
    void BFT2(struct Node* root, vector<int>&a) // noreen // breadth first traversal
    {
	...
	bool addHelper(Node* temp, int value, int pre) { // noreen
	...
	void add(int value, int pre){ // noreen
    ...
    bool ancestors( Node *root ,int target, vector<int>& a) // Mariam
    {
    ...
    bool ifNodeExists( Node *node , int key) // yara
{
    if (node == NULL)
        return false;
    if (node->data == key)
...
void zero_padding(struct Node* node, int c=0) // rawan
{
...
//------------------------------------------------------------------------------------------------------------------
	...
	void numChildNodes(Node* temp, int value, int found, int *x){ // rawan
...
// GRAPHICAL REPRESENTATION
	void tree_graph(int x, int y, int* array, int index, int total_elements){ // rawan
...
// ================================================ functions =======================================================
bool found(int a, vector<int> c) // mariam
{
...
bool takenOrNot(vector<int>& vect , int temp_course_code ,int n){ // rawan
    for (int i = 0; i <  n; i++){
...
//----------------------------------------------------------------------------------
vector<int> graph_student(vector<int> took, vector<int> can, Content Test, BT &obj2) // mariam
{
	...
	obj2.zero_padding(obj2.root); //changes it to full binary tree
	vector<int> answer;
...
vector<int> topological(vector<int>take, vector<int>took, BT T , string s[], int arr_size, Content Test, BT &obj2) // mariam
{
...
vector<int> execution(BT obj, Content Test, BT &obj2) // yara & mariam
{
   //======================= user input =============================
